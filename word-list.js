const engWordList = [
    { word: "book", hint: "Something you read with pages.", difficulty: 1 },
    { word: "school", hint: "A place where you learn.", difficulty: 1 },
    { word: "computer", hint: "A machine for doing things with information.", difficulty: 1 },
    ...
    { word: "science", hint: "Studying how things work.", difficulty: 1 },
    { word: "mathematics", hint: "Working with numbers and shapes.", difficulty: 1 },
    { word: "history", hint: "Learning about the past.", difficulty: 1 },
    { word: "music", hint: "Making sounds in a nice way.", difficulty: 1 },
    { word: "alphabet", hint: "Letters that make words.", difficulty: 1 },
    { word: "grammar", hint: "Rules for speaking and writing.", difficulty: 1 },
    { word: "dictionary", hint: "A book of word meanings.", difficulty: 1 },
    { word: "geography", hint: "Learning about places.", difficulty: 1 },
    { word: "language", hint: "How people talk to each other.", difficulty: 1 },
    { word: "poetry", hint: "Fancy words that sound nice.", difficulty: 1 },
    { word: "essay", hint: "A short piece of writing about something.", difficulty: 1 },
    { word: "art", hint: "Making pretty things.", difficulty: 1 },
    { word: "exam", hint: "A big test.", difficulty: 1 },

    { word: "novel", hint: "A long story that isn't real.", difficulty: 2 },
    { word: "university", hint: "A school for grown-ups.", difficulty: 2 },
    { word: "internet", hint: "Worldwide computer network.", difficulty: 2 },
    { word: "lecture", hint: "A talk to teach people something.", difficulty: 2 },
    { word: "research", hint: "Looking for facts.", difficulty: 2 },
    { word: "experiment", hint: "Trying things to learn.", difficulty: 2 },
    { word: "equation", hint: "Math sentence.", difficulty: 2 },
    { word: "biography", hint: "Life story by someone else.", difficulty: 2 },
    { word: "symphony", hint: "Big, long music for lots of instruments.", difficulty: 2 },
    { word: "synonym", hint: "Same meaning word.", difficulty: 2 },
    { word: "encyclopedia", hint: "Book with lots of facts.", difficulty: 2 },
    ...
    { word: "sculpture", hint: "Making 3D art.", difficulty: 2 },
    { word: "photography", hint: "Taking and editing pictures.", difficulty: 2 },
    { word: "symmetry", hint: "Same on both sides.", difficulty: 2 },    
...
const mathWordList = [
    ...
    { word: "fraction", hint: "Part of a whole number.", difficulty: 1 },
    ...
    { word: "percent", hint: "A part of 100.", difficulty: 1 },
    { word: "geometry", hint: "Study of shapes and space.", difficulty: 1 },
    { word: "triangle", hint: "A shape with three sides.", difficulty: 1 },
    { word: "circle", hint: "Shape with all points equidistant from center.", difficulty: 1 },
    { word: "area", hint: "Space inside a shape.", difficulty: 1 },
    { word: "volume", hint: "Space occupied by a 3D object.", difficulty: 1 },
    { word: "equation", hint: "Mathematical statement with equal sign.", difficulty: 1 },
    { word: "variable", hint: "Symbol for changing quantity.", difficulty: 1 },
    { word: "function", hint: "Relationship between inputs and outputs.", difficulty: 1 },
    { word: "graph", hint: "Visual representation of data.", difficulty: 1 },
    ...
    { word: "mode", hint: "Most common number.", difficulty: 2 },
    { word: "median", hint: "Middle number when numbers are in order.", difficulty: 2 },
    { word: "prime", hint: "Number divisible only by 1 and itself.", difficulty: 2 },
    { word: "composite", hint: "Number with more than two factors.", difficulty: 2 },
    { word: "even", hint: "Number divisible by 2.", difficulty: 2 },
    { word: "odd", hint: "Number not divisible by 2.", difficulty: 2 },
    ...
    { word: "rectangle", hint: "Four-sided shape with 90-degree angles.", difficulty: 3 },
    { word: "square", hint: "Rectangle with all sides equal.", difficulty: 3 },
    { word: "cube", hint: "Three-dimensional square.", difficulty: 3 },
...
const scienceWordList = [
    ...
    { word: "osmosis", hint: "Water moves through a membrane.", difficulty: 2 },
    ...
    { word: "inertia", hint: "Object's resistance to change in motion.", difficulty: 2 },
    ...
    { word: "conductor", hint: "Material that allows electricity to flow.", difficulty: 2 },
    { word: "insulator", hint: "Material that does not allow electricity to flow.", difficulty: 2 },
